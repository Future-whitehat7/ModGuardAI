...
export const Demo = () => {
  ...
  const [currentView, setCurrentView] = useState<'upload' | 'challenge'>('upload');
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-gray-900">ModGuard AI Demo</span>
              </div>
            </div>
            
            <div className="flex items-center space-x-4">
              <button
                onClick={() => setCurrentView(currentView === 'upload' ? 'challenge' : 'upload')}
                className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
              >
                {currentView === 'upload' ? 'Try Challenge' : 'Try Upload'}
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {currentView === 'upload' ? (
          <>
            {/* Page Header */}
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900">Content Analysis Demo</h1>
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="text-sm text-gray-500">
                    Supports: Images (JPG, PNG, GIF), Videos (MP4, MOV, AVI), Audio (MP3, WAV), Documents (PDF)
                  </div>
                </div>
              </div>
            </motion.div>
