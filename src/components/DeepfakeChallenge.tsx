            ...
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-md rounded-2xl p-8 border border-slate-700/50 shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="bg-gradient-to-r from-purple-500/30 to-purple-500/10 border border-purple-500/30 text-white hover:text-white px-8 py-3 rounded-lg font-medium hover:bg-purple-500/20 transition-all inline-flex items-center space-x-2"
                >
